...
public class WordList {
	 ...
	 */
	public void addToKnown(String word, ArrayList<String> syns, ArrayList<String> ants) {
	...
	/**
	 * addToEnc adds a word to the list of "encountered" words -- those seen, but not known.
	 * @param word		String for word to be added
	 */
	...
	/** getRandomWord pulls a random word from the encountered words and returns it
	 * 
